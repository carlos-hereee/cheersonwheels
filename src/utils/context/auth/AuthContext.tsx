...
//   // user actions
//   const setTheme = useCallback((data: string) => dispatch({ type: A_AUTH.SET_THEME, payload: data }), []);
//   const setUpdateTier = useCallback((a?: ISubscription) => dispatch({ type: A_AUTH.SET_UPDATE_TIER, payload: a }), []);
